...
public class BorrowerController {
	...
	@RequestMapping(path = "/lms/borrower/{cardNo}")
	...
	@RequestMapping(path = "/lms/borrower/{cardNo}/loans")
	...
	@RequestMapping(path = "/lms/borrower/branches")
	...
	@RequestMapping(path = "/lms/borrower/branches/{branchId}")
	...
	@RequestMapping(path = "/lms/borrower/branches/{branchId}/books")
	...
	@PostMapping(path = "/lms/borrower/return")
	...
	@PostMapping(path = "/lms/borrower/{cardNo}/borrow")
